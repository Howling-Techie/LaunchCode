...
const PagePathsWithComponents = /* @__PURE__ */ Object.assign({ "./pages/Home.tsx": __vite_glob_0_0 });
...
function App() {
  return /* @__PURE__ */ jsx(Routes, { children: routes.map(({ path, component: RouteComp }) => {
    return /* @__PURE__ */ jsx(Route, { path, element: /* @__PURE__ */ jsx(RouteComp, {}) }, path);
  }) });
}
function render(url) {
  return ReactDOMServer.renderToString(
    /* @__PURE__ */ jsx(React.StrictMode, { children: /* @__PURE__ */ jsx(StaticRouter, { location: url, basename: "/LaunchCode", children: /* @__PURE__ */ jsx(App, {}) }) })
  );
}
export {
  render
